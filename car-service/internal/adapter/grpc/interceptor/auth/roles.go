...
func buildPolicies() map[string]methodPolicy {
	return map[string]methodPolicy{
		...
		carsvc.CarService_GetCarStatusHistory_FullMethodName:   {},
		carsvc.CarService_GetCarFuelHistory_FullMethodName:     {},
		carsvc.CarService_GetCarLocationHistory_FullMethodName: {},
		carsvc.CarService_GetCarBatteryHistory_FullMethodName:  {},
		carsvc.CarService_GetCarMileageHistory_FullMethodName:  {},

		// ZoneService — restricted to fleet roles.
		carsvc.ZoneService_CreateZone_FullMethodName: {allowedRoles: fleetRoles},
		carsvc.ZoneService_GetZone_FullMethodName:    {allowedRoles: fleetRoles},
		carsvc.ZoneService_ListZones_FullMethodName:  {allowedRoles: fleetRoles},
		...
		carsvc.CarInsuranceService_GetCarInsurance_FullMethodName:                {allowedRoles: fleetRoles},
		carsvc.CarInsuranceService_ListCarInsurances_FullMethodName:              {allowedRoles: fleetRoles},
