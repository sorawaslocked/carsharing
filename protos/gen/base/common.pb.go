...
func (x *PricingSnapshot) GetRatePerKmTenge() int32 {
...
func (x *PricingSnapshot) GetFreeMinutes() int32 {
...
func (x *PricingSnapshot) GetMinChargeTenge() int32 {
...
func (x *PricingSnapshot) GetOvertimePolicy() string {
...
func (x *PricingSnapshot) GetOvertimeRateTenge() int32 {
...
const file_base_common_proto_rawDesc = "" +
	...
	"\tlongitude\x18\x02 \x01(\x01R\tlongitude\"\x82\x03\n" +
	...
	"\x14_overtime_rate_tengeB5Z3github.com/sorawaslocked/car-rental-protos/gen/baseb\x06proto3"
...
var file_base_common_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_base_common_proto_goTypes = []any{
	...
	(*PricingSnapshot)(nil), // 3: base.PricingSnapshot
}
...
func file_base_common_proto_init() {
	...
	file_base_common_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
