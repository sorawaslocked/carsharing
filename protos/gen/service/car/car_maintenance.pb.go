...
type CompleteMaintenanceRecordRequest struct {
	...
	MileageAtCompletionKm int32                  `protobuf:"varint,2,opt,name=mileage_at_completion_km,json=mileageAtCompletionKm,proto3" json:"mileage_at_completion_km,omitempty"`
...
func (x *CompleteMaintenanceRecordRequest) GetMileageAtCompletionKm() int32 {
	if x != nil {
...
const file_service_car_car_maintenance_proto_rawDesc = "" +
	...
	"\arecords\x18\x01 \x03(\v2\x1e.base.car.CarMaintenanceRecordR\arecords\"\xea\x01\n" +
	" CompleteMaintenanceRecordRequest\x12\x1b\n" +
	"\trecord_id\x18\x01 \x01(\tR\brecordId\x127\n" +
	"\x18mileage_at_completion_km\x18\x02 \x01(\x05R\x15mileageAtCompletionKm\x12\x1d\n" +
	"\n" +
