...
var file_service_user_user_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
var file_service_user_user_proto_depIdxs = []int32{
	10, // 0: service.user.GetResponse.user:type_name -> base.User
	10, // 1: service.user.GetAllResponse.users:type_name -> base.User
